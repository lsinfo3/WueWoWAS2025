...
<div class="content-container">
 <div class="content-block">
  <img src="{{ '/assets/images/emnify_new.png' | relative_url }}" style="max-width: 20%; display: inline-block; margin: 0px 10px 0px 10px" class="image left" >
  <div class="text">
...
<hr>
 ...
 <div class="content-block">
  <img src="{{ '/assets/images/infosim.png' | relative_url }}" style="max-width: 20%; display: inline-block; background-color:white; margin: 0px 10px 0px 10px" class="image left">
  <div class="text">
...
<div class="content-container">
 <div class="content-block">
   <img src="{{ '/assets/images/vde.jpg' | relative_url }}" style="max-width: 20%; display: inline-block; margin: 0px 10px 0px 10px" >
   <div class="text">
...
<hr>
 ...
 <div class="content-block">
  <img src="{{ '/assets/images/kuvs.png' | relative_url }}" style="max-width: 20%; display: inline-block; margin: 0px 10px 0px 10px" >
  <div class="text">
 ...
 <div class="content-block">
  <img src="{{ '/assets/images/gi.png' | relative_url }}" style="max-width: 20%; display: inline-block; background-color:white; margin: 0px 10px 0px 10px" >
  <div class="text">
...
<div class="content-container">
 <div class="content-block">
  <img src="{{ '/assets/images/logo-SUSTAINET-Advance.jpg' | relative_url }}" style="max-width: 20%; display: inline-block; margin: 0px 10px 0px 10px" >
  <div class="text">
 ...
 <div class="content-block">
  <img src="{{ '/assets/images/origami_logo.png' | relative_url }}" style="max-width: 20%; display: inline-block; margin: 0px 10px 0px 10px" >
  <div class="text">
